#!/usr/bin/env bash
#
# orchestrate.sh — Multi-agent brainstorming: teaching what manifolds ARE
#
# Focused on gradually building foundational understanding of manifolds
# for business managers. This is a PRELUDE lesson — it teaches the concepts
# that a later "manifolds in ML" lesson will build upon.
#
...
#
# Example:
#   bash orchestrate.sh "Gradually teach manifolds to managers using spheres, tori, and Klein bottles" ./output 20
#
# Outputs:
...
OUTPUT_DIR="${2:-./brainstorm-output}"
MAX_ROUNDS="${3:-20}"
MIN_ROUNDS=10
...
# Multi-Agent Brainstorming Transcript
